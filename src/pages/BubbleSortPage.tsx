...
const BubbleSortPage = () => {
    ...
    return (
        <div>
            ...
            {selectedTab === 1 && (
                <AnimationManager input={generateRandomArray(15)} algorithm={Algorithm.BubbleSort} visualizationGraphics={Visualization.ListBar}
            ...
            {selectedTab === 0 && (
                <>
                    ...
                    <p>
                        The best case scenario for bubble sort is the case where the list is already sorted from
                        lowest to highest and has a running time of O(n) comparisons and O(1) swap:
                    </p>
