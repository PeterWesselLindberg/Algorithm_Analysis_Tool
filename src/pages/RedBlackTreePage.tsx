        ...
        <div>
            ...
            { selectedTab === 2 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.BFSRBSearch} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 3 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.DFSRBSearch} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 4 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.RBTreeSearch} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 5 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.RBDelete} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 0 && (
                <>
                    ...
                    <p> 
                        Given the root of a red-black tree, we need to insert a new node with a given value. All the nodes in the red-black tree have distinct values and we may assume that the the new value to be inserted<br/>
                    ...
                    <ol>
                        ...
                        <li>
                            If the target node only has one child, the target node is deleted and the child gets elevated becoming the new child of its' grandparent.<br/>
                            The red-black properties of the tree then has to be fixed dependent on the situation.
                        </li>

                        <li>
                            If the target node has two children, the target node's in-order successor (the smallest value in the right subtree) replaces the target node's value<br/>
                    ...
                    <ol>
                        <li>
                            If the target node's sibling is red, then recolor the sibling to black and the parent to red. Then rotate the subtree.<br/>
                            This then converts the tree into one of the remaining cases.
                        </li>
                          
                        <li>
                            If the target node's sibling is black and both of the sibling's children are black. Recolor the sibling red. If the parent is red recolor i black and stop.<br/>
                            If the parent is black continue fixing the tree upwards towards the root.
                        </li>

                        <li>
                            If the target node's sibling is black, its near child is red and the far child is black.<br/>
                        ...
                        <li>
                            If the target node's sibling is black and the far child is red. Rotate left around the parent and give the sibling the parent's original color.<br/>
