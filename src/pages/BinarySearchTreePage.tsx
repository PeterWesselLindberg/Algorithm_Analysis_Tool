        ...
        <div>
            ...
            { selectedTab === 2 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.BFSTreeSearch} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 3 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.DFSTreeSearch} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 4 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.BSTTreeSearch} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 5 && (
                <>
                    ...
                    <AnimationManager input={{type: "bst", values, target}} algorithm={Algorithm.BSTDelete} visualizationGraphics={Visualization.TVListTree}
                    structure={StructureColor.BSTColor} />
                </>
            )}
            ...
            { selectedTab === 0 && (
                <>
                    ...
                    <p> 
                        Given the root of a BST, we need to insert a new node with a given value. All the nodes in the BST have distinct values and we may assume that the the new value to be inserted<br/>
